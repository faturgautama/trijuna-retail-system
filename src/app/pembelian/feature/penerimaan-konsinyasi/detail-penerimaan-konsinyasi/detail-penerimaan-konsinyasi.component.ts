...
@Component({
    selector: 'app-detail-penerimaan-konsinyasi',
    templateUrl: './detail-penerimaan-konsinyasi.component.html',
    styleUrls: ['./detail-penerimaan-konsinyasi.component.scss']
})
export class DetailPenerimaanKonsinyasiComponent implements OnInit, AfterViewInit {
    ...
    getPenerimaanTanpaPoById(): void {
        ...
        this._store.dispatch(new PenerimaanKonsinyasiAction.GetById(id))
            .pipe(
                map((result: any) => {
                    if (result.penerimaan_konsinyasi.entities.success) {
                        return result.penerimaan_konsinyasi.entities.data;
                    } else {
                        return result;
                    }
                })
    ...
    handleSubmitForm(): void {
        const id_penerimaan = this.CustomForm.handleGetFieldValue('id_penerimaan');

        this._store.dispatch(new PenerimaanKonsinyasiAction.Validasi(id_penerimaan))
