...
@Component({
    selector: 'app-input-retur-konsinyasi',
    templateUrl: './input-retur-konsinyasi.component.html',
    styleUrls: ['./input-retur-konsinyasi.component.scss']
})
export class InputReturKonsinyasiComponent implements OnInit {
    ...
    constructor(
        ...
        this.FormInputDetail = {
            ...
            type: 'add',
            form_props: {
                id: 'form_retur_konsinyasi_detail',
                type: 'save',
                is_inline: true,
                fields: [
                    {
    ...
    handleSubmitForm(): void {
        ...
        this._store.dispatch(new ReturKonsinyasiAction.Save(payload))
            .subscribe((result) => {
