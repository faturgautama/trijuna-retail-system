...
@Component({
    selector: 'app-history-retur-konsinyasi',
    templateUrl: './history-retur-konsinyasi.component.html',
    styleUrls: ['./history-retur-konsinyasi.component.scss']
})
export class HistoryReturKonsinyasiComponent implements OnInit {
    ...
    handleClickButtonNav(args: string): void {
        this._router.navigate(['pembelian/retur-konsinyasi/input']);
    }

    handleSearchOffcanvas(args: any): void {
        this._store.dispatch(new ReturKonsinyasiAction.GetAll(args))
            .subscribe((result) => {
                if (result.retur_konsinyasi.entities.success) {
                    this.GridProps.dataSource = result.retur_konsinyasi.entities.data;
                }
            })
    }

    handleRowDoubleClicked(args: any): void {
        this._router.navigate(['pembelian/retur-konsinyasi/detail', args.id_retur_pembelian]);
    }
