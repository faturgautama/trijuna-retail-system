    ...
    constructor(
        ...
        this.GridProps = {
            ...
            column: [
                ...
                { field: 'hpp_average', headerName: 'HPP Average', class: 'text-end', format: 'currency' },
                { field: 'harga_jual', headerName: 'Harga Jual', class: 'text-end', format: 'currency' },
                { field: 'sub_total_fisik_harga_jual', headerName: 'Total Fisik Harga Jual', class: 'text-end', format: 'currency' },
                { field: 'sub_total_capture_harga_jual', headerName: 'Total Capture Harga Jual', class: 'text-end', format: 'currency' },
                { field: 'sub_total_selisih_harga_jual', headerName: 'Total Selisih Harga Jual', class: 'text-end', format: 'currency' },
                { field: 'sub_total_fisik_hpp_average', headerName: 'Total Fisik HPP', class: 'text-end', format: 'currency' },
                { field: 'sub_total_capture_hpp_average', headerName: 'Total Capture HPP', class: 'text-end', format: 'currency' },
                { field: 'sub_total_selisih_hpp_average', headerName: 'Total Selisih HPP', class: 'text-end', format: 'currency' },
            ],
            dataSource: [],
            height: "100%",
            showPaging: false,
