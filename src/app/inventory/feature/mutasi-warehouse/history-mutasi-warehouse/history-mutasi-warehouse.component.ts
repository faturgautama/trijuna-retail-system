    ...
    constructor(
        ...
        this.GridProps = {
            column: [
                ...
                { field: 'tanggal_mutasi_warehouse', headerName: 'TGL. MUTASI', width: 150, sortable: true, resizable: true, cellRenderer: (e: any) => { return this._utilityService.FormatDate(e.value) } },
                { field: 'warehouse_asal', headerName: 'WAREHOUSE ASAL', width: 170, sortable: true, resizable: true },
                { field: 'warehouse_tujuan', headerName: 'WAREHOUSE TUJUAN', width: 170, sortable: true, resizable: true },
                {
                ...
                {
                    field: 'total_harga', headerName: 'GRAND TOTAL', width: 150, sortable: true, resizable: true, cellClass: 'text-right',
                    cellRenderer: (e: any) => { return this._utilityService.FormatNumber(e.value) }
                },
                { field: 'status_mutasi_warehouse', headerName: 'STATUS MUTASI', width: 150, sortable: true, resizable: true },
            ],
            dataSource: [],
