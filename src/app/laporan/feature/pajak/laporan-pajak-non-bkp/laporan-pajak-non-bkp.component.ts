...
@Component({
    selector: 'app-laporan-pajak-non-bkp',
    templateUrl: './laporan-pajak-non-bkp.component.html',
    styleUrls: ['./laporan-pajak-non-bkp.component.scss']
})
export class LaporanPajakNonBkpComponent implements OnInit {
    ...
    handleSearchOffcanvas(args: any): void {
        ...
        if (startDate && endDate) {
            this._laporanPajakService
                .getLaporanPajakNonBkp({ startdate: startDate, enddate: endDate })
                .subscribe((result) => {
                    if (result.success) {
