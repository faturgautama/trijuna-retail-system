...
@Component({
    selector: 'app-laporan-pembelian-rokok',
    templateUrl: './laporan-pembelian-rokok.component.html',
    styleUrls: ['./laporan-pembelian-rokok.component.scss']
})
export class LaporanPembelianRokokComponent implements OnInit {
    ...
    handleClickButtonNav(args: string): void {
        if (args == 'export_excel') {
            ...
            this._utilityService.exportToExcel({ worksheetName: 'Laporan Pembelian Rokok', dataSource: dataSource })
        };
    }
    ...
    handleSearchOffcanvas(): void {
        ...
        this._laporanInventoryService
            .getLaporanPembelianRokok(filter.stardate, filter.enddate)
            .subscribe((result) => {
                if (result.success) {
