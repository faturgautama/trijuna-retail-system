...
@Component({
    selector: 'app-laporan-omset-breakdown-monthly-hpp-profit',
    templateUrl: './laporan-omset-breakdown-monthly-hpp-profit.component.html',
    styleUrls: ['./laporan-omset-breakdown-monthly-hpp-profit.component.scss']
})
export class LaporanOmsetBreakdownMonthlyHppProfitComponent implements OnInit {
    ...
    constructor(
        ...
        this.DashboardProps = {
            title: 'Laporan Profit Breakdown Monthly',
            button_navigation: [
        ...
        this.GridProps = {
            column: [
                ...
                { field: 'hpp', headerName: 'HPP', flex: 250, sortable: true, resizable: true, cellClass: 'text-right', cellRenderer: (e: any) => { return this._utilityService.FormatNumber(e.value, 'Rp. ') }, },
                { field: 'profit', headerName: 'PROFIT', flex: 250, sortable: true, resizable: true, cellClass: 'text-right', cellRenderer: (e: any) => { return this._utilityService.FormatNumber(e.value, 'Rp. ') }, },
            ],
            dataSource: [],
    ...
    handleClickButtonNav(args: string): void {
        if (args == 'export_excel') {
            ...
            this._utilityService.exportToExcel({ worksheetName: 'Laporan Profit Breakdown Monthly', dataSource: dataSource })
        };
    }
    ...
    handleSearchOffcanvas(): void {
        ...
        this._laporanOmsetService
            .getLaporanOmsetProfitBreakdownMonthly(filter.stardate)
            .subscribe((result) => {
                if (result.success) {
                    ...
                    this.TotalHpp = result.data.total_hpp;
                    this.TotalProfit = result.data.total_profit;
                }
            })
    }
