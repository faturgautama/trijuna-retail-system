...
@Component({
    selector: 'app-laporan-omset-breakdown-daily-hpp',
    templateUrl: './laporan-omset-breakdown-daily-hpp.component.html',
    styleUrls: ['./laporan-omset-breakdown-daily-hpp.component.scss']
})
export class LaporanOmsetBreakdownDailyHppComponent implements OnInit {
    ...
    constructor(
        ...
        this.DashboardProps = {
            title: 'Laporan Profit Breakdown Daily',
            button_navigation: [
    ...
    handleClickButtonNav(args: string): void {
        if (args == 'export_excel') {
            ...
            this._utilityService.exportToExcel({ worksheetName: 'Laporan Profit Breakdown Daily', dataSource: dataSource })
        };
    }
    ...
    handleSearchOffcanvas(): void {
        ...
        this._laporanOmsetService
            .getLaporanOmsetProfitBreakdownDaily(filter.stardate)
            .subscribe((result) => {
                if (result.success) {
