...
@Component({
    selector: 'app-laporan-penjualan-grosir',
    templateUrl: './laporan-penjualan-grosir.component.html',
    styleUrls: ['./laporan-penjualan-grosir.component.scss']
})
export class LaporanPenjualanGrosirComponent implements OnInit {
    ...
    handleClickButtonNav(args: string): void {
        if (args == 'export_excel') {
            ...
            this._utilityService.exportToExcel({ worksheetName: 'Laporan Penjualan Grosir', dataSource: dataSource })
        };
    }
    ...
    handleSearchOffcanvas(): void {
        ...
        this._laporanInventoryService
            .getLaporanPenjualanGrosir(filter.stardate, filter.enddate)
            .subscribe((result) => {
                if (result.success) {
