...
@Component({
    selector: 'app-laporan-penjualan-sembako',
    templateUrl: './laporan-penjualan-sembako.component.html',
    styleUrls: ['./laporan-penjualan-sembako.component.scss']
})
export class LaporanPenjualanSembakoComponent implements OnInit {
    ...
    constructor(
        ...
        this.DashboardProps = {
            title: 'Laporan Penjualan Sembako',
            button_navigation: [
    ...
    handleClickButtonNav(args: string): void {
        if (args == 'export_excel') {
            ...
            this._utilityService.exportToExcel({ worksheetName: 'Laporan Penjualan Sembako', dataSource: dataSource })
        };
    }
    ...
    handleSearchOffcanvas(): void {
        ...
        this._laporanInventoryService
            .getLaporanPenjualanSembako(filter.stardate, filter.enddate)
            .subscribe((result) => {
                if (result.success) {
