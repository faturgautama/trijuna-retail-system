...
export namespace PenerimaanKonsinyasiModel {
    export interface IPenerimaanKonsinyasiHeader {
        id_pemesanan: number
        id_supplier: number
    ...
    export interface IPenerimaanKonsinyasi {
        ...
        created_by: string
        updated_by: string
        detail_pemesanan: IPenerimaanKonsinyasiDetail[]
    }

    export class GetAllPenerimaanKonsinyasi implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IPenerimaanKonsinyasi[]
    }

    export interface SavePenerimaanKonsinyasi {
        id_supplier: number
        no_nota: string
        tanggal_nota: string
        id_lokasi: number
        ...
        detail: SavePenerimaanKonsinyasiDetail[]
    }

    export interface SavePenerimaanKonsinyasiDetail {
        urut: number
        id_barang: number
        banyak: number
        kode_satuan: string
    ...
    export class GetByIdPenerimaanKonsinyasi implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IPenerimaanKonsinyasi
    }
