...
export namespace ReturKonsinyasiModel {
    export interface IReturKonsinyasiHeader {
        id_pemesanan: number
        id_supplier: number
    ...
    export interface IReturKonsinyasi {
        ...
        created_by: string
        updated_by: string
        detail_pemesanan: IReturKonsinyasiDetail[]
    }

    export class GetAllReturKonsinyasi implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IReturKonsinyasi[]
    }

    export interface SaveReturKonsinyasi {
        jenis_retur: string
        ...
        qty: number
        total_harga: number
        detail: SaveReturKonsinyasiDetail[]
    }

    export interface SaveReturKonsinyasiDetail {
        urut: number
        id_barang: number
        banyak: number
        kode_satuan: string
    ...
    export class GetByIdReturKonsinyasi implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IReturKonsinyasi
    }
