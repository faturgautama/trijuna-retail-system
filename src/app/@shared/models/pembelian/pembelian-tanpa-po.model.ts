...
export namespace PembelianTanpaPoModel {
    export interface IPembelianTanpaPoHeader {
        id_pemesanan: number
        id_supplier: number
    ...
    export interface IPembelianTanpaPoDetail {
    ...
    export interface IPembelianTanpaPo {
        id_pemesanan: number
        id_supplier: number
        kode_supplier: string
        nama_supplier: string
        ...
        created_by: string
        updated_by: string
        detail_pemesanan: IPembelianTanpaPoDetail[]
    }

    export class GetAllPembelianTanpaPo implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IPembelianTanpaPo[]
    }

    export interface SavePembelianTanpaPo {
        id_supplier: number
        no_nota: string
        tanggal_nota: string
        id_lokasi: number
        ...
        detail: SavePembelianTanpaPoDetail[]
    }

    export interface SavePembelianTanpaPoDetail {
        urut: number
        id_barang: number
        banyak: number
        kode_satuan: string
    ...
    export class GetByIdPembelianTanpaPo implements HttpRequestBaseModel {
        success!: boolean
        message!: string
        data!: IPembelianTanpaPo
    }
