...
export class InputStokOpnameService {
    ...
    kalkulasi(id_setting_stok_opname: number): Observable<any> {
        return this._httpRequestService.getRequest(`${environment.endpoint}/input_stok_opname/kalkulasi/${id_setting_stok_opname}`);
    }

    finalisasi(payload: any): Observable<any> {
        return this._httpRequestService.postRequest(`${environment.endpoint}/input_stok_opname/finalisasi`, payload);
    }
}
