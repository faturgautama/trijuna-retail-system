...
export class MutasiKeluarService {
    ...
    validasiOnline(payload: any): Observable<any> {
        return this._httpRequestService.postRequest(`${environment.endpoint}/mutasi_lokasi_keluar/validasi_online`, payload);
    }
